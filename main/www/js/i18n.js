...
const I18N = {
  en: {
    ...
    "check.persist.accept": "Earlier observations were retained across the restart.",
    "check.persist.power_cycle": "Power was interrupted. This diagnosis has no flash archive, so collection restarted with this boot.",
  ...
  de: {
    ...
    "check.persist.accept": "Frühere Beobachtungen wurden über den Neustart hinweg übernommen.",
    "check.persist.power_cycle": "Die Stromversorgung war unterbrochen. Diese Diagnose hat kein Flash-Archiv; deshalb begann die Sammlung mit diesem Start neu.",
