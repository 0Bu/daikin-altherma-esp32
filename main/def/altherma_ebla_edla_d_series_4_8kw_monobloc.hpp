#pragma once
// GENERATED profile from X10A value definitions: Altherma(EBLA-EDLA D series 4-8kW Monobloc)
...
inline constexpr ValueDef altherma_ebla_edla_d_series_4_8kw_monobloc[] = {
