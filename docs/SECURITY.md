...
seconds for two stable host-visible 48 KiB / 20 KiB samples while retaining the exact failed token;
...
must still hold; a second refusal or any other failure blocks. The firmware retains the measured 48
