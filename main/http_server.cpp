...
void http_start() {
    ...
    // explicit POST /diag/clear and POST /coredump/clear routes raised the total to 36; the one
    // query-selected, device-local UI locale asset route raises the current exact total to 37.
