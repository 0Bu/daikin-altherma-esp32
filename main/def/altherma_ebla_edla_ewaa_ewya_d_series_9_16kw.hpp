#pragma once
// GENERATED profile from X10A value definitions: Altherma(EBLA-EDLA  EWAA-EWYA D SERIES 9-16KW)
...
inline constexpr ValueDef altherma_ebla_edla_ewaa_ewya_d_series_9_16kw[] = {
    {0x00, 0, 802, 0, -1, "*Refrigerant type"},  // default_on
