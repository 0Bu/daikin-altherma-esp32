...
I18N.zh = localeValues([
  ...
  /* dyn.state_help_recording */ "已确认的空间供暖正在运行，且室温输入有效，因此正在记录原始室温误差。请结合运行时长和限幅数据评估季节趋势；单个样本不是结论。",
...
MODEL_DESCRIPTION_I18N.zh = modelDescriptionValues([
  ...
  ["测量静止时段R5T水温：K/h为最大小时降温；水泵仅为相关非原因。≥0.8 K/h给出“说明”，上限1.85 K/h为项目推算。200L估算仅供补充用电参考，非实测电耗。"], // health_dhw_loss
