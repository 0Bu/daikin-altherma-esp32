...
const I18N = {
  en: {
    ...
    "check.guide": "How to read this card", "check.guide.value": "Plain-language guide",
    ...
    "check.persist.label": "Data window:",
    "check.persist.accept": "Earlier observations were restored from the device across the restart or power interruption.",
    "check.persist.power_cycle": "Power was interrupted, but no reusable completed diagnosis hour was found in device storage; collection started with this boot.",
    "check.persist.no_record": "No reusable earlier diagnosis window was found; collection started with this boot.",
    "check.persist.wrong_version": "The stored diagnosis format belongs to another firmware version and was not reused.",
    "check.persist.wrong_layout": "This update changed what the stored counters mean. The older window was discarded instead of mixing unlike data.",
    "check.persist.bad_crc": "The retained diagnosis data failed its integrity check and was discarded.",
    "check.persist.model_changed": "The detected heat-pump profile differs from the stored window, so collection restarted.",
    "check.persist.safe_mode": "Recovery mode does not continue plant diagnosis; an older window was not reused.",
    ...
    "normal.label": "Normal:",
    "meaning.label": "How to read it:", "action.label": "What you can do:",
    ...
    "hist.sources_differ": "sources differ", "hist.single_source": "one source only",
    ...
    "ref.save_help": "Save subscribes immediately. The source remains unavailable until a readable, fresh MQTT value arrives.",
  ...
  de: {
    ...
    "check.guide": "So liest du diese Karte", "check.guide.value": "Einfach erklärt",
    ...
    "check.persist.label": "Datenfenster:",
    "check.persist.accept": "Frühere Beobachtungen wurden aus dem Gerät über den Neustart oder die Stromunterbrechung hinweg übernommen.",
    "check.persist.power_cycle": "Die Stromversorgung war unterbrochen, aber im Gerätespeicher wurde keine wiederverwendbare abgeschlossene Diagnosestunde gefunden; die Sammlung begann mit diesem Start.",
    "check.persist.no_record": "Es wurde kein wiederverwendbares früheres Diagnosefenster gefunden; die Sammlung begann mit diesem Start.",
    "check.persist.wrong_version": "Das gespeicherte Diagnoseformat gehört zu einer anderen Firmware-Version und wurde nicht übernommen.",
    "check.persist.wrong_layout": "Dieses Update hat die Bedeutung gespeicherter Zähler geändert. Das ältere Fenster wurde verworfen, statt ungleiche Daten zu vermischen.",
    "check.persist.bad_crc": "Die behaltenen Diagnosedaten haben die Integritätsprüfung nicht bestanden und wurden verworfen.",
    "check.persist.model_changed": "Das erkannte Wärmepumpenprofil passt nicht zum gespeicherten Fenster; deshalb begann die Sammlung neu.",
    "check.persist.safe_mode": "Im Wiederherstellungsmodus läuft die Anlagendiagnose nicht weiter; ein älteres Fenster wurde nicht übernommen.",
    ...
    "normal.label": "Normal:",
    "meaning.label": "So liest du es:", "action.label": "Was du tun kannst:",
    ...
    "hist.sources_differ": "Quellenabweichung", "hist.single_source": "nur eine Quelle",
    ...
    "ref.save_help": "Speichern abonniert sofort. Bis ein lesbarer, frischer MQTT-Wert eintrifft, bleibt die Quelle nicht verfügbar.",
    "syslog.title": "Syslog-Server", "syslog.hostport": "Host : Port",
