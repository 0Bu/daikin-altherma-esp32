...
const I18N = {
  en: {
    ...
    "ref.hint": "This stage supports one MQTT source in Observe mode. Save validates current temperature, target and source time, then stores the mapping only after a live test. Enabled and HVAC mode optionally gate control eligibility; thermostat active state does not. The timestamp may be RFC3339 text or Unix seconds. Delete removes the saved source and captured sample.",
  ...
  de: {
    ...
    "ref.hint": "Diese Stufe unterstützt eine MQTT-Quelle im Modus Beobachten. Speichern prüft Temperatur, Ziel und Quellzeit und übernimmt die Zuordnung erst nach einem Live-Test. Freigabe und HVAC-Modus können die Regeleignung begrenzen; der aktive Thermostatstatus tut das nicht. Der Zeitstempel darf RFC3339-Text oder Unix-Sekunden sein. Löschen entfernt Quelle und erfassten Messwert.",
    "syslog.title": "Syslog-Server", "syslog.hostport": "Host : Port",
