#pragma once
// GENERATED profile from X10A value definitions: Altherma(HPSU6_ultra)
...
inline constexpr ValueDef altherma_hpsu6_ultra[] = {
    ...
    {0x62, 15, 105, 2, 2, "Pressure sensor"},  // default_on
