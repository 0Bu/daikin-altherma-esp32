...
const I18N = {
  en: {
    ...
    "dyn.room_invalid": "Room reading out of range", "dyn.room_no_setpoint": "Room target missing",
    "dyn.room_no_time": "Room reading has no timestamp", "dyn.room_no_flag": "Room state field missing",
    "dyn.room_source": "Room-temperature source", "dyn.configured": "Configured",
    ...
    "dyn.outdoor_help_setup": "An M5Stack ENV III on the board's Grove port can supply this. Mounted outdoors and shaded, it measures the outdoor air continuously — unlike the heat pump's own sensor, which stops being refreshed while the outdoor unit rests.",
    ...
    "ref.broker_off": "MQTT broker disabled", "ref.retained": "retained",
    ...
    "ref.detail.configuration_label": "Configuration:",
    "ref.detail.status_label": "Status:", "ref.detail.eligibility_label": "Usable:",
    "ref.status.fresh": "Current",
    "ref.status.stale": "Stale", "ref.status.waiting": "Waiting",
    "ref.status.unavailable": "Unavailable",
    "ref.detail.fresh": "The latest MQTT sample passed mapping, plausibility and freshness checks.",
    "ref.detail.stale": "The latest sample is too old or its source time is not trustworthy; it is not recorded by the diagnosis.",
    "ref.detail.waiting": "No valid MQTT sample has been received yet.",
    "ref.detail.error": (e) => `The latest MQTT sample was rejected: ${e}.`,
    "ref.detail.temperature_label": "Room temperature:",
    "ref.detail.temperature": (v) => `${v} °C is the current temperature reported by the configured room source.`,
    "ref.detail.setpoint_label": "Target temperature:",
    "ref.detail.setpoint": (v) => `${v} °C is the room target reported by the same source.`,
    "ref.detail.age_label": "Age:",
    "ref.detail.age": (v) => `The source measurement was accepted ${v}.`,
    "ref.detail.source_label": "Source:",
    "ref.detail.source": (v) => `${v} via the configured exact MQTT topic and JSON paths.`,
    ...
    "ref.hint": "One MQTT source is supported. Save tests the mapping against a current MQTT message before storing it, and a stored mapping is subscribed and decoded from then on — saving it is what starts the subscription, there is no separate switch. Delete removes the source and the captured sample.",
  ...
  de: {
    ...
    "dyn.room_invalid": "Raumwert außerhalb des Bereichs", "dyn.room_no_setpoint": "Raum-Sollwert fehlt",
    "dyn.room_no_time": "Raumwert ohne Zeitstempel", "dyn.room_no_flag": "Zustandsfeld des Raums fehlt",
    "dyn.state_x10a": "X10A offline", "dyn.state_homehub": "HomeHub offline",
    ...
    "dyn.room_source": "Raumtemperaturquelle", "dyn.configured": "Konfiguriert",
    ...
    "dyn.outdoor_help_setup": "Ein M5Stack ENV III am Grove-Port des Boards kann diesen Wert liefern. Außen und verschattet montiert misst er die Außenluft lückenlos — anders als der Fühler der Wärmepumpe, der nicht mehr aktualisiert wird, während die Außeneinheit ruht.",
    ...
    "ref.broker_off": "MQTT-Broker deaktiviert", "ref.retained": "retained",
    ...
    "ref.detail.status_label": "Status:", "ref.detail.eligibility_label": "Verwertbar:",
    "ref.status.fresh": "Aktuell",
    "ref.status.stale": "Veraltet", "ref.status.waiting": "Wartet",
    "ref.status.unavailable": "Nicht verfügbar",
    "ref.detail.fresh": "Der letzte MQTT-Messwert hat Zuordnungs-, Plausibilitäts- und Frischeprüfung bestanden.",
    "ref.detail.stale": "Der letzte Messwert ist zu alt oder seine Quellzeit nicht vertrauenswürdig; er wird von der Diagnose nicht erfasst.",
    "ref.detail.waiting": "Es wurde noch kein gültiger MQTT-Messwert empfangen.",
    "ref.detail.error": (e) => `Der letzte MQTT-Messwert wurde verworfen: ${e}.`,
    "ref.detail.temperature_label": "Raumtemperatur:",
    "ref.detail.temperature": (v) => `${v} °C ist die aktuelle Temperatur der konfigurierten Raumquelle.`,
    "ref.detail.setpoint_label": "Solltemperatur:",
    "ref.detail.setpoint": (v) => `${v} °C ist der von derselben Quelle gemeldete Raumsollwert.`,
    "ref.detail.age_label": "Alter:",
    "ref.detail.age": (v) => `Der Quellmesswert wurde ${v} übernommen.`,
    "ref.detail.source_label": "Quelle:",
    "ref.detail.source": (v) => `${v} über das konfigurierte exakte MQTT-Topic und die JSON-Pfade.`,
    ...
    "ref.hint": "Es wird eine MQTT-Quelle unterstützt. Speichern prüft die Zuordnung mit einer aktuellen MQTT-Nachricht, bevor sie übernommen wird; ab dann wird die gespeicherte Zuordnung abonniert und ausgewertet — das Speichern startet das Abonnement, einen eigenen Schalter gibt es nicht. Löschen entfernt Quelle und erfassten Messwert.",
    "syslog.title": "Syslog-Server", "syslog.hostport": "Host : Port",
