#pragma once
// GENERATED profile from X10A value definitions: Altherma(LT-D7_E_BML)
...
inline constexpr ValueDef altherma_lt_d7_e_bml[] = {
    ...
    {0x10, 6, 114, 2, 1, "Target Discharge Temp."},  // default_on
    ...
    {0xA0, 2, 119, 2, 1, "Outdoor heat exchanger temp."},  // default_on
