...
const HEALTHY = () => ({
  ...
  circulation_source: { configured: true, name: "Example pump", topic: "fixtures/pump/status",
  ...
  weather_forecast: { configured: true, provider: "open-meteo", model: "icon_seamless",
    ...
    latitude: "12.3", longitude: "23.4", state: "ok", outdoor_mean_2h_c: 9.2,
  ...
  syslog: { configured: true, resolved: true, reachable: true, host: "203.0.113.5", port: 514 },
...
const REMOVE = {
  ...
  safeMode(s) {
    s.sys = { ...s.sys, safe_mode: true, reset_reason: "task_wdt" };
