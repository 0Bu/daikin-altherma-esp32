#pragma once
// GENERATED profile from X10A value definitions: Altherma(EPGA D EAB-EAV-EAVZ D(J) series 11-16kW)
...
inline constexpr ValueDef altherma_epga_d_eab_eav_eavz_d_j_series_11_16kw[] = {
