...
I18N.cs = localeValues([
  ...
  /* service.title */ "Chladivový okruh při vytápění",
  /* service.state.waiting */ "ČEKÁ NA VYTÁPĚNÍ",
  /* service.state.observing */ "ZAZNAMENÁVÁ",
  /* service.state.limited */ "ZAZNAMENÁVÁ · CHYBÍ DATA",
  /* service.state.interrupted */ "POZASTAVENO",
  /* service.row.window */ "Dosud zaznamenáno",
  /* service.row.reason */ "Proč tento stav?",
  /* service.reason.unsupported_profile */ "Tento model neposkytuje všechny potřebné hodnoty.",
  /* service.reason.compressor_not_running */ "Kompresor neběží.",
  /* service.reason.unsupported_or_unknown_mode */ "Tepelné čerpadlo není v běžném vytápění nebo režim nelze zjistit.",
  /* service.reason.dhw_path */ "Tepelné čerpadlo ohřívá teplou vodu.",
  /* service.reason.defrost */ "Venkovní jednotka se odmrazuje.",
  /* service.reason.unit_fault */ "Tepelné čerpadlo hlásí poruchu.",
  /* service.reason.special_controller_phase */ "Je aktivní krátká fáze spuštění nebo zvláštní regulace.",
  /* service.reason.missing_fresh_signal */ "Chybí alespoň jedna potřebná aktuální hodnota.",
  /* service.reason.poll_gap */ "Připojení X10A bylo přerušeno nebo záměrně pozastaveno.",
  /* service.window */ (d, n) => `${d} · ${n} aktuálních měření`,
  /* service.help.observing */ "Hodnoty se nyní souvisle zaznamenávají během běžného vytápění.",
  /* service.help.limited */ "Záznam běží, ale některé doplňkové srovnávací hodnoty chybí.",
  /* service.help.interrupted */ "Záznam skončil a automaticky se spustí při dalším vhodném vytápění.",
  /* service.common */ "U podporovaných modelů se spustí automaticky při běžném vytápění; bez servisního režimu a změn nastavení. Neposuzuje chladivo ani normální rozsah. Hodnota ventilu: příkaz, ne změřená poloha.",
