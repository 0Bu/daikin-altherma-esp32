...
// broadcaster is gone (legacy-241) and the buffer stays, because the property it buys is not the
// caller count. Returns pins strictly ascending, like board_pins(). Size `out` with BOARD_PINS_MAX.
