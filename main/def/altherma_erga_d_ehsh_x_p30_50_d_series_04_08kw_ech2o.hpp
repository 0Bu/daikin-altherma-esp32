#pragma once
// GENERATED profile from X10A value definitions: Altherma(ERGA D EHSH-X P30-50 D series 04-08kW-ECH2O)
...
inline constexpr ValueDef altherma_erga_d_ehsh_x_p30_50_d_series_04_08kw_ech2o[] = {
    ...
    {0x61, 8, 105, 2, 1, "[HPSU] Tr return Temp (R4T)"},  // default_on
