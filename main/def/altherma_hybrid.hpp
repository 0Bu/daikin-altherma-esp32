#pragma once
// GENERATED profile from X10A value definitions: Altherma(Hybrid)
...
inline constexpr ValueDef altherma_hybrid[] = {
    ...
    {0x20, 0, 105, 2, 1, "Outdoor air temp."},  // default_on
    {0x20, 2, 105, 2, 1, "O/U Heat Exch. Temp."},  // default_on
    {0x20, 4, 105, 2, 1, "Discharge pipe temp."},  // default_on
    {0x20, 6, 105, 2, 1, "Suction pipe temp."},
    {0x20, 8, 105, 2, 1, "O/U Heat Exch. Mid-temp."},  // default_on
    ...
    {0x61, 2, 105, 2, 1, "Outlet Water Heat Exch. Temp. (R1T)"},  // default_on
    {0x61, 4, 105, 2, 1, "Outlet Water BUH Temp. (R2T)"},  // default_on
    ...
    {0x61, 12, 105, 2, 1, "RT Temp."},  // default_on
    {0x61, 14, 105, 2, 1, "Outdoor Ambient or Ext Sensor"},  // default_on
    ...
    {0x64, 2, 316, 1, -1, "Hybrid Op. Mode"},  // default_on
    {0x64, 2, 303, 1, -1, "Boiler Operation Demand"},  // default_on
    {0x64, 2, 302, 1, -1, "Boiler DHW Demand"},  // default_on
    {0x64, 3, 105, 2, -1, "BE_COP"},  // default_on
    {0x64, 5, 105, 2, 1, "Hybrid Heating Target Temp."},  // default_on
    {0x64, 7, 105, 2, 1, "Boiler Heating Target Temp."},  // default_on
};
