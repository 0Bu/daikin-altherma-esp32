...
const I18N = {
  en: {
    ...
    "ref.enabled_path": "Enabled JSON path · optional",
    "ref.hvac_mode_path": "HVAC-mode JSON path · optional", "ref.max_age": "Maximum age · seconds",
    ...
    "ref.enabled_path_help": "Enable state as true/false or 1/0.",
    "ref.hvac_mode_path_help": "Operating mode as text; use ‘heat’ for heating.",
    ...
    "ref.err_enabled_path": "Enter a dot-separated enabled-state path, for example thermostat.enabled",
    "ref.err_hvac_mode_path": "Enter a dot-separated HVAC-mode path, for example thermostat.hvac_mode",
  ...
  de: {
    ...
    "ref.enabled_path": "JSON-Pfad Freigabe · optional",
    "ref.hvac_mode_path": "JSON-Pfad HVAC-Modus · optional", "ref.max_age": "Maximales Alter · Sekunden",
    ...
    "ref.enabled_path_help": "Freigabe als true/false oder 1/0.",
    "ref.hvac_mode_path_help": "Betriebsart als Text; zum Heizen „heat“.",
    ...
    "ref.err_enabled_path": "Einen punktgetrennten Freigabe-Pfad eingeben, zum Beispiel thermostat.enabled",
    "ref.err_hvac_mode_path": "Einen punktgetrennten HVAC-Modus-Pfad eingeben, zum Beispiel thermostat.hvac_mode",
