#pragma once
// GENERATED profile from X10A value definitions: Altherma(EPRA E ETSH-X 16P30-50 E series 8-12kW-ECH2O)
...
inline constexpr ValueDef altherma_epra_e_etsh_x_16p30_50_e_series_8_12kw_ech2o[] = {
    ...
    {0xA1, 0, 119, 2, 1, "(Raw data)Water heat exchanger inlet temp."},  // default_on
    {0xA1, 2, 119, 2, 1, "(Raw data)Water heat exchanger outlet temp."},  // default_on
