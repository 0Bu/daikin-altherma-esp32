#pragma once
// GENERATED profile from X10A value definitions: Altherma(EBLA-EDLA D series 9-16kW Monobloc)
...
inline constexpr ValueDef altherma_ebla_edla_d_series_9_16kw_monobloc[] = {
    ...
    {0x65, 0, 105, 2, 1, "Outlet water heat exchanger temp (hydro split model) DLWB2"},
