...
// project: partitions.csv already states the premise for the `history` partition — the OTA stream
// writes the inactive APP slot and never the table at 0x8000, so a board keeps whatever table it was
