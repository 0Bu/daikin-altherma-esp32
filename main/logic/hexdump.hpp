...
// wrong WHILE the compressor ran. legacy-209 added the complementary runtime capture and the resulting
// wire evidence resolved legacy-194 through logic/conv_override.hpp. The detect dump remains intentionally
