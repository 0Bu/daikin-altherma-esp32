...
I18N.ja = localeValues([
  ...
  /* service.title */ "冷媒回路サービス観察",
  /* service.state.waiting */ "待機中",
  /* service.state.observing */ "観察中",
  /* service.state.limited */ "制限あり",
  /* service.state.interrupted */ "中断",
  /* service.row.window */ "現在のウィンドウ",
  /* service.row.reason */ "理由",
  /* service.reason.unsupported_profile */ "プロファイルに必要な信号がありません。",
  /* service.reason.compressor_not_running */ "圧縮機停止。",
  /* service.reason.unsupported_or_unknown_mode */ "暖房中でないか、モード不明。",
  /* service.reason.dhw_path */ "給湯作動中。",
  /* service.reason.defrost */ "除霜中。",
  /* service.reason.unit_fault */ "ユニット異常あり。",
  /* service.reason.special_controller_phase */ "起動、再起動、油戻し、または均圧中。",
  /* service.reason.missing_fresh_signal */ "必要な最新信号なし。",
  /* service.reason.poll_gap */ "X10A ポーリング中断または意図的な一時停止。",
  /* service.window */ (d, n) => `${d} · 新鮮なサンプル ${n} 件`,
  /* service.help.observing */ "同一 X10A 読取りの最新値が、この条件で連続しています。",
  /* service.help.limited */ "連続中ですが、任意の温度・圧力・外気・制御フェーズ情報が不足。",
  /* service.help.interrupted */ "ウィンドウ終了。次の適格な読取りはゼロから開始。",
  /* service.common */ "観察専用：サービス・全負荷試験ではなく、安定状態や冷媒量を証明せず、正常範囲も判定しません。EEV パルスは指令で、弁のフィードバックではありません。",
  /* check.fault */ "機器異常",
