...
- **✅ 🧪 Getting the evidence off the board — and what must not come with it.** Everything above is
  ...
  HomeHub was auto-discovered, its serial-derived hostname) and scrubs the log lines that interpolate a host, an IP
