...
// high-frequency intersection of the decoded model catalog by the offline generator
// (gen_profiles.py, maintained outside this repo); keep in sync when regenerating and verify rows
// against docs/REGISTERS.md. Pages a given unit lacks simply time out and are skipped by the poller.
