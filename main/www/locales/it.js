...
I18N.it = localeValues([
  ...
  /* service.title */ "Circuito frigorifero durante il riscaldamento",
  /* service.state.waiting */ "ATTENDE IL RISCALDAMENTO",
  /* service.state.observing */ "REGISTRA",
  /* service.state.limited */ "REGISTRA · DATI MANCANTI",
  /* service.state.interrupted */ "IN PAUSA",
  /* service.row.window */ "Registrato finora",
  /* service.row.reason */ "Perché questo stato?",
  /* service.reason.unsupported_profile */ "Questo modello non fornisce tutte le letture necessarie.",
  /* service.reason.compressor_not_running */ "Il compressore non è in funzione.",
  /* service.reason.unsupported_or_unknown_mode */ "La pompa di calore non è nel normale riscaldamento o la modalità non è disponibile.",
  /* service.reason.dhw_path */ "La pompa di calore sta riscaldando l’acqua sanitaria.",
  /* service.reason.defrost */ "L’unità esterna è in sbrinamento.",
  /* service.reason.unit_fault */ "La pompa di calore segnala un guasto.",
  /* service.reason.special_controller_phase */ "È attiva una breve fase di avvio o regolazione speciale.",
  /* service.reason.missing_fresh_signal */ "Manca almeno una lettura attuale necessaria.",
  /* service.reason.poll_gap */ "La connessione X10A è stata interrotta o messa intenzionalmente in pausa.",
  /* service.window */ (d, n) => `${d} · ${n} ${n === 1 ? "lettura attuale" : "letture attuali"}`,
  /* service.help.observing */ "I valori vengono ora registrati in modo continuo durante il normale riscaldamento.",
  /* service.help.limited */ "La registrazione è attiva, ma mancano alcune letture aggiuntive di confronto.",
  /* service.help.interrupted */ "La registrazione è terminata e riparte automaticamente al prossimo riscaldamento adatto.",
  /* service.common */ "Sui modelli compatibili parte automaticamente nel normale riscaldamento; senza modalità di servizio o modifiche. Non valuta refrigerante o intervalli normali. Valore valvola: comando, non posizione misurata.",
