#pragma once
// GENERATED profile from X10A value definitions: Altherma(EGSAH-X-EWSAH-X-D series 6-10kW GEO3)
...
inline constexpr ValueDef altherma_egsah_x_ewsah_x_d_series_6_10kw_geo3[] = {
    ...
    {0x20, 2, 105, 2, 1, "2 phase thermistor (R4T)"},  // default_on
    {0x20, 4, 105, 2, 1, "Discharge pipe temp."},  // default_on
    {0x20, 6, 105, 2, 1, "Suction pipe temp.(R3T)"},  // default_on
    {0x20, 8, 105, 2, 1, "Entering brine temp.(R5T)"},  // default_on
    {0x20, 10, 105, 2, 1, "Leaving brine temp.(R6T)"},  // default_on
    ...
    {0x30, 1, 211, 1, -1, "Brine pump feedback"},  // default_on
    ...
    {0x60, 6, 219, 1, -1, "Indoor Unit Capacity"},  // default_on
