...
const I18N = {
  en: {
    ...
    "dyn.mode_help": "Observe reads and validates configured inputs but does not change the heat pump or its leaving-water target.",
    "dyn.strategy_help": "No control strategy is active. Input data is collected for evaluation only; no correction is calculated or applied.",
    ...
    "ref.hint": "This stage supports one MQTT source in Observe mode. Save tests the mapping with a current MQTT message before storing it. Delete removes the source and captured sample.",
  ...
  de: {
    ...
    "dyn.mode_help": "Im Modus Beobachten werden konfigurierte Eingänge gelesen und geprüft; Wärmepumpe und Vorlaufsollwert werden nicht verändert.",
    "dyn.strategy_help": "Es ist keine Regelstrategie aktiv. Eingangsdaten werden nur zur Auswertung erfasst; eine Korrektur wird weder berechnet noch angewendet.",
    ...
    "ref.hint": "Diese Stufe unterstützt eine MQTT-Quelle im Modus Beobachten. Speichern prüft die Zuordnung mit einer aktuellen MQTT-Nachricht, bevor sie übernommen wird. Löschen entfernt Quelle und erfassten Messwert.",
    "syslog.title": "Syslog-Server", "syslog.hostport": "Host : Port",
