...
const I18N = {
  en: {
    ...
    "hist.defrost_run": (when, d) => `${when} · active window approx. ${d}`,
    ...
    "hist.quiet_run": (when, d) => `${when} · active interval approx. ${d}`,
  ...
  de: {
    ...
    "hist.defrost_run": (when, d) => `${when} · aktives Zeitfenster ca. ${d}`,
    ...
    "hist.quiet_run": (when, d) => `${when} · aktives Zeitfenster ca. ${d}`,
