...
I18N.nb = localeValues([
  ...
  /* service.title */ "Kjølekrets under oppvarming",
  /* service.state.waiting */ "VENTER PÅ OPPVARMING",
  /* service.state.observing */ "REGISTRERER",
  /* service.state.limited */ "REGISTRERER · DATA MANGLER",
  /* service.state.interrupted */ "PAUSET",
  /* service.row.window */ "Registrert hittil",
  /* service.row.reason */ "Hvorfor denne statusen?",
  /* service.reason.unsupported_profile */ "Denne modellen gir ikke alle nødvendige målinger.",
  /* service.reason.compressor_not_running */ "Kompressoren går ikke.",
  /* service.reason.unsupported_or_unknown_mode */ "Varmepumpen er ikke i vanlig romoppvarming, eller modusen er utilgjengelig.",
  /* service.reason.dhw_path */ "Varmepumpen varmer tappevann.",
  /* service.reason.defrost */ "Utedelen avrimes.",
  /* service.reason.unit_fault */ "Varmepumpen melder en feil.",
  /* service.reason.special_controller_phase */ "En kort oppstarts- eller spesiell reguleringsfase er aktiv.",
  /* service.reason.missing_fresh_signal */ "Minst én nødvendig aktuell måling mangler.",
  /* service.reason.poll_gap */ "X10A-forbindelsen ble avbrutt eller satt på pause med vilje.",
  /* service.window */ (d, n) => `${d} · ${n} aktuelle ${n === 1 ? "måling" : "målinger"}`,
  /* service.help.observing */ "Målinger registreres nå kontinuerlig under vanlig oppvarming.",
  /* service.help.limited */ "Registreringen er aktiv, men noen ekstra sammenligningsmålinger mangler.",
  /* service.help.interrupted */ "Registreringen sluttet og starter automatisk ved neste egnede oppvarming.",
  /* service.common */ "På støttede modeller starter den automatisk ved vanlig oppvarming; uten servicemodus eller innstillingsendring. Vurderer ikke kjølemiddel eller normalområde. Ventilverdi: kommando, ikke målt posisjon.",
