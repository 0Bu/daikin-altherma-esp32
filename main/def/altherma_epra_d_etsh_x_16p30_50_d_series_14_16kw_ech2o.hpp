#pragma once
// GENERATED profile from X10A value definitions: Altherma(EPRA D ETSH-X 16P30-50 D series 14-16kW-ECH2O)
...
inline constexpr ValueDef altherma_epra_d_etsh_x_16p30_50_d_series_14_16kw_ech2o[] = {
    ...
    {0x61, 2, 105, 2, 1, "[HPSU] Tv inflow Temp  (R1T)"},  // default_on
    {0x61, 4, 105, 2, 1, "[HPSU] Tvbh inflow Temp after Buffer/BUH (R2T)"},  // default_on
