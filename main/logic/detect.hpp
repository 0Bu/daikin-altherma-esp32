...
// When a page fails to answer due to timeouts or CRC errors (rather than an affirmative NAK),
// the reduced fingerprint can match a smaller/different profile family (e.g. Monobloc -> Geo3).
// An incomplete sweep must be corroborated across consecutive passes before committing.
