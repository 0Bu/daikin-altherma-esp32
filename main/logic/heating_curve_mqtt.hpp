...
struct HeatingCurveMqttFields {
    // Canonical single-room input (legacy-288). Unavailable numbers render null; numeric validity
    // flags and a stable reason code let metrics consumers distinguish absence from a real zero.
