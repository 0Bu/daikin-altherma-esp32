#pragma once
// GENERATED profile from X10A value definitions: Altherma(ERRA E ELSH-X 12P30-50 EF series 8-12kW-ECH2O)
...
inline constexpr ValueDef altherma_erra_e_elsh_x_12p30_50_ef_series_8_12kw_ech2o[] = {
    ...
    {0x21, 10, 105, 2, 1, "Compressor outlet temperature"},  // default_on
    {0x21, 12, 105, 2, 1, "Injection tube temperature"},  // default_on
    ...
    {0x63, 8, 105, 2, 1, "[HPSU] Mixed leaving water temperature after the tank R7T (DLWA2)"},  // default_on
    ...
    {0x65, 4, 105, 2, 1, "[EKMIK] Bizone kit mixed leaving water temperature R1T"},  // default_on
    {0x65, 6, 152, 1, -1, "[EKMIK] Bizone kit mix valve position M1S"},  // default_on
};
