...
const DEMO = (() => {
  ...
  const status = (i) => ({
    ...
    wifi: { ssid: "ExampleNet", ip: "192.0.2.170", rssi: -58, connected: true,
            bssid: "02:00:00:00:00:01", mac: "02:00:00:00:01:70", std: "Wi-Fi 5", rolled_back: false },
    mqtt: { configured: true, connected: true, tls: false, has_creds: true,
            broker: "mqtt://192.0.2.26:1883", error: "" },
