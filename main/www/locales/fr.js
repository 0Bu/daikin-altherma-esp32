// translation-source: b2c0aaf45bb2281cc8e48c65dd712a6f0ae9064ec6d18044c1c72654f43336c6
I18N.fr = localeValues([
  ...
  /* service.title */ "Circuit frigorifique pendant le chauffage",
  /* service.state.waiting */ "ATTEND LE CHAUFFAGE",
  /* service.state.observing */ "ENREGISTREMENT",
  /* service.state.limited */ "ENREGISTREMENT · DONNÉES MANQUANTES",
  /* service.state.interrupted */ "EN PAUSE",
  /* service.row.window */ "Enregistré jusqu’ici",
  /* service.row.reason */ "Pourquoi cet état ?",
  /* service.reason.unsupported_profile */ "Ce modèle ne fournit pas toutes les mesures nécessaires.",
  /* service.reason.compressor_not_running */ "Le compresseur ne fonctionne pas.",
  /* service.reason.unsupported_or_unknown_mode */ "La pompe à chaleur n’est pas en chauffage normal ou son mode est indisponible.",
  /* service.reason.dhw_path */ "La pompe à chaleur chauffe l’eau chaude sanitaire.",
  /* service.reason.defrost */ "L’unité extérieure est en dégivrage.",
  /* service.reason.unit_fault */ "La pompe à chaleur signale un défaut.",
  /* service.reason.special_controller_phase */ "Une courte phase de démarrage ou de régulation spéciale est active.",
  /* service.reason.missing_fresh_signal */ "Au moins une mesure actuelle nécessaire manque.",
  /* service.reason.poll_gap */ "La connexion X10A a été interrompue ou volontairement mise en pause.",
  /* service.window */ (d, n) => `${d} · ${n} ${n === 1 ? "mesure actuelle" : "mesures actuelles"}`,
  /* service.help.observing */ "Les valeurs sont maintenant enregistrées en continu pendant un chauffage normal.",
  /* service.help.limited */ "L’enregistrement est actif, mais certaines mesures de comparaison supplémentaires manquent.",
  /* service.help.interrupted */ "L’enregistrement est terminé et redémarre automatiquement au prochain chauffage adapté.",
  /* service.common */ "Sur les modèles compatibles, démarre automatiquement en chauffage normal ; sans mode maintenance ni réglage modifié. N’évalue ni la charge de fluide ni les plages normales. Valeur de vanne : commande, pas position mesurée.",
