...
MODEL_DESCRIPTION_I18N.ja = modelDescriptionValues([
  ...
  ["除霜回数と圧縮機時間比を集計。3回以上かつ15%超で注記のみ。Daikin限界値ではなく、湿度と熱交換器表面温度は不明です。"], // health_defrost
