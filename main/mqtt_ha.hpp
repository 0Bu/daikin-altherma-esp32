...
// JSON every DAIKIN_MQTT_PUBLISH_INTERVAL_S. Read-only (no command subscriptions; the optional
// control relays own their own topics in control.cpp). No-op if mqtt_uri is empty.
#include <string>
