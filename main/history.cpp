...
struct Trend {
    ...
    // legacy-35-legacy-39 shape: well-formed, plausible, wrongly labelled.
    char             unit[8] = {0};
};
...
inline void advance_raster_locked(int64_t now_us, uint32_t bucket) {
    if (!s_have_bucket) {
        ...
        // older instant. Only reachable since legacy-367 gave the raster a second, independent advancer.
