#pragma once
// GENERATED profile from X10A value definitions: Daikin Mini chiller(EWAQ-EWYQ B series 4-8kW)
...
inline constexpr ValueDef minichiller_ewaq_ewyq_b_series_4_8kw[] = {
    ...
    {0x20, 2, 105, 2, 1, "Outdoor heat exchanger temp."},  // default_on
    {0x20, 4, 105, 2, 1, "Discharge pipe temp."},  // default_on
    {0x20, 6, 105, 2, 1, "Suction Pipe Temperature"},  // default_on
    {0x20, 8, 105, 2, 1, "Outdoor heat exchanger mid temp."},  // default_on
    {0x20, 10, 105, 2, 1, "Liquid pipe temp."},  // default_on
    {0x20, 12, 105, 2, 1, "Fin Temp."},  // default_on
