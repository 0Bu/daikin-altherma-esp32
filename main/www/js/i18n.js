...
const I18N = {
  en: {
    ...
    "probe.title": "X10A Diagnosis",
    "probe.readonly": "Read only",
    ...
    "probe.size_help": "Bytes to decode", "probe.converter_auto": "Automatic — test all matching converters",
  ...
  de: {
    ...
    "probe.title": "X10A Diagnose",
    "probe.readonly": "Nur lesen",
    "probe.intro": "Direkte Abfrage einer X10A-Registerseite mit optionaler Converter-Auswertung.",
    "probe.request": "Anfrage", "probe.register": "Register", "probe.manual": "Manuelle Eingabe",
    "probe.page": "Registerseite", "probe.offset": "Payload-Offset", "probe.size": "Feldbreite",
    "probe.byte": "Byte", "probe.bytes": "Bytes", "probe.converter": "Converter",
    "probe.page_help": "Hex oder dezimal · 0…255", "probe.offset_help": "Index im Payload · 0…31",
    "probe.size_help": "Zu dekodierende Bytes", "probe.converter_auto": "Automatisch – alle passenden Converter prüfen",
    "probe.converter_auto_help": (size) => `Prüft alle implementierten Converter für ${size} Byte.`,
    "probe.converter_selected": (id, description) => `Converter ${id}: ${description}`,
    "probe.conv_raw_byte": "Rohbyte · 0…255", "probe.conv_unsigned_byte": "vorzeichenloses Rohbyte",
    "probe.conv_tenth_byte": "Rohbyte × 0,1", "probe.conv_unsigned_half_byte": "vorzeichenloses Byte × 0,5",
    "probe.conv_signed_raw_le": "vorzeichenbehaftete Ganzzahl · Little-Endian", "probe.conv_signed_raw_be": "vorzeichenbehaftete Ganzzahl · Big-Endian",
    "probe.conv_signed_256_le": "vorzeichenbehaftet ÷ 256 · Little-Endian", "probe.conv_signed_256_be": "vorzeichenbehaftet ÷ 256 · Big-Endian",
    "probe.conv_signed_tenth_le": "vorzeichenbehaftet × 0,1 · Little-Endian", "probe.conv_signed_tenth_be": "vorzeichenbehaftet × 0,1 · Big-Endian",
    ...
    "probe.conv_signed_128_le": "vorzeichenbehaftet ÷ 256 × 2 · Little-Endian", "probe.conv_signed_128_be": "vorzeichenbehaftet ÷ 256 × 2 · Big-Endian",
    "probe.conv_signed_half_be": "vorzeichenbehaftet × 0,5 · Big-Endian", "probe.conv_signed_hundredth_be": "vorzeichenbehaftet × 0,01 · Big-Endian",
    "probe.conv_unsigned_raw_le": "vorzeichenlose Ganzzahl · Little-Endian", "probe.conv_unsigned_raw_be": "vorzeichenlose Ganzzahl · Big-Endian",
    "probe.conv_unsigned_half_be": "vorzeichenlos × 0,5 · Big-Endian", "probe.conv_saturation": "Druck → Sättigungstemperatur",
    "probe.conv_raw_fan": "Rohbyte / Lüfterstufe", "probe.conv_capacity": "Leistungsklasse des Innengeräts",
    "probe.conv_eeprom_digit": "rohe EEPROM-Ziffer", "probe.conv_eeprom_pair": "rohes EEPROM-Ziffernpaar",
    "probe.conv_bits_high": "Bits 4–6 · 3-Bit-Zähler", "probe.conv_bits_low": "Bits 0–2 · 3-Bit-Zähler",
    "probe.conv_operation_mode": "Betriebsart", "probe.conv_error_class": "Fehlerklasse",
    "probe.conv_error_code": "Daikin-Fehlercode", "probe.conv_indoor_mode": "Innengeräte-Modus · oberes Nibble",
    "probe.conv_hybrid_mode": "Hybrid-Betriebsart", "probe.conv_bit": (bit) => `Bit ${bit} · 0 oder 1`,
    ...
    "probe.response": "Antwort", "probe.frame": "Frame", "probe.payload": "Payload",
    "probe.slice": "Ausgewählte Bytes", "probe.interpretation": "Interpretation",
    ...
    "probe.no_decodes": "Kein Converter-Ergebnis.", "probe.refused": "Wert verworfen",
    "probe.unimplemented": "Nicht implementiert", "probe.aliases": "auch",
    "probe.invalid": "Registerseite, Offset, Feldbreite und Converter prüfen.",
    "probe.failed": "Anfrage fehlgeschlagen.",
    "probe.status_ok": "Antwort gültig", "probe.status_busy": "Belegt",
    "probe.status_no_link": "Kein X10A-Link", "probe.status_timeout": "Zeitüberschreitung",
    "probe.status_no_reply": "Keine Antwort", "probe.status_rejected": "Abgewiesen",
    "probe.status_bad_crc": "Prüfsumme falsch", "probe.status_unexpected_reply": "Unerwartete Antwort",
    "probe.status_invalid_length": "Länge ungültig", "probe.status_short_reply": "Teilantwort",
    "probe.status_out_of_bounds": "Außerhalb des Payloads", "probe.status_error": "Fehler",
