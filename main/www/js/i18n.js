...
const I18N = {
  en: {
    ...
    "dyn.state_waiting": "Waiting for space heating", "dyn.state_room": "Room input unavailable",
    ...
    "dyn.inactive": "Not active", "dyn.input_error": "Input error",
    "dyn.shadow_strategy": "P controller, ±2 K",
    "dyn.enable": "Heating-curve diagnosis",
    "dyn.enable_help": "Off by default. Enabling records, every 30 minutes, the leaving-water offset the weather-dependent curve would need to bring the reference room to its target. Aggregated over a heating season that answers whether the curve is set correctly, and by how much it is not. Requires an MQTT broker, a room source with target and timestamp, and a HomeHub. Nothing is ever written to the heat pump — the firmware has no write path.",
    "dyn.enabled": "Heating-curve diagnosis on",
    "dyn.disabled": "Heating-curve diagnosis off",
  ...
  de: {
    ...
    "dyn.state_waiting": "Wartet auf Heizbetrieb", "dyn.state_room": "Raumeingang fehlt",
    "dyn.state_x10a": "X10A offline", "dyn.state_homehub": "HomeHub offline",
    ...
    "dyn.inactive": "Nicht aktiv", "dyn.input_error": "Eingangsfehler",
    "dyn.shadow_strategy": "P-Regler, ±2 K",
    "dyn.enable": "Heizkurven-Diagnose",
    "dyn.enable_help": "Standardmäßig aus. Eingeschaltet zeichnet die Firmware alle 30 Minuten auf, welchen Vorlauf-Offset die witterungsgeführte Heizkurve bräuchte, um den Referenzraum auf seinen Sollwert zu bringen. Über eine Heizsaison aggregiert beantwortet das, ob die Kurve richtig eingestellt ist und um wie viel nicht. Erforderlich sind ein MQTT-Broker, eine Raumquelle mit Sollwert und Zeitstempel sowie ein HomeHub. An die Wärmepumpe wird nichts geschrieben — die Firmware hat keinen Schreibpfad.",
    "dyn.enabled": "Heizkurven-Diagnose eingeschaltet",
    "dyn.disabled": "Heizkurven-Diagnose ausgeschaltet",
