#pragma once
// GENERATED profile from X10A value definitions: Altherma(EGSQH-A series 10kW GEO2)
...
inline constexpr ValueDef altherma_egsqh_a_series_10kw_geo2[] = {
    ...
    {0x20, 12, 105, 2, 1, "Heat sink temp.(R10T)"},  // default_on
    ...
    {0x21, 7, 105, 2, 1, "Brine inlet temp."},  // default_on
    {0x21, 9, 105, 2, 1, "Brine outlet temp."},  // default_on
