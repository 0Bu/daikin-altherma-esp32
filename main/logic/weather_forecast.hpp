...
// firmware requests one configured coordinate every 45 minutes, derives only the two bounded
// features needed by #288, and never stores the provider response or writes heat-pump controls.
#include <cmath>
#include <cstddef>
#include <cstdint>
#include <cstdio>
