...
const DESCRIPTIONS = [
  ...
  { exact: true, re: /^leaving water main heating offset$/i,
    what: "The signed correction applied to the main-zone heating leaving-water target. The firmware may write only this HomeHub register through its default-off internal actuator; this row is the independent readback.",
    normal: "The accepted range is -10 to +10 K. A confirmed value is not proof of heat delivery: the separate space-operation state must also be active.",
    de: { what: "Die vorzeichenbehaftete Korrektur des Heiz-Vorlaufziels der Hauptzone. Die Firmware darf ausschließlich dieses HomeHub-Register über ihren standardmäßig deaktivierten internen Aktor schreiben; diese Zeile ist der unabhängige Rücklesewert.",
          normal: "Zulässig sind -10 bis +10 K. Ein bestätigter Wert beweist keine Wärmeabgabe: Zusätzlich muss der getrennte Raumheizbetrieb aktiv sein." } },
