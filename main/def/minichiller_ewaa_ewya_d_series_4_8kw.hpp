#pragma once
// GENERATED profile from X10A value definitions: Daikin Mini chiller(EWAA-EWYA D series 4-8kW)
...
inline constexpr ValueDef minichiller_ewaa_ewya_d_series_4_8kw[] = {
