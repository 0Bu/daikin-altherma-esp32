// Czech device-UI locale. Loaded from the ESP32 only when selected or browser-detected.
I18N.cs = {
  "sys.nodata": "Žádná data", "sys.unreachable": "Nedostupné",
  "sys.x10a_down": "X10A je offline", "sys.mb_carrying": "Provozní režim není znám — hodnoty z Modbusu",
  "sys.mb_only": "X10A je offline — hodnoty z Modbusu", "sys.mb_source": "X10A je offline · Modbus",
  "mode.stop": "Zastaveno", "mode.heat": "Vytápění", "mode.cool": "Chlazení", "mode.space": "Vytápění/chlazení prostoru",
  "mode.dhw": "Teplá voda", "mode.heat_dhw": "Vytápění + teplá voda",
  "mode.cool_dhw": "Chlazení + teplá voda", "mode.space_dhw": "Vytápění/chlazení prostoru + teplá voda",
  "sys.unreachable_sub": "Zařízení není dostupné — opakuji pokus…",
  "sys.waiting": "Čekám na tepelné čerpadlo…", "sys.operating": "V provozu",
  "sys.standby": "Pohotovostní režim — neběží", "sys.defrosting": "Odmrazování",
  ...
  "sys.online": "Online", "sys.fault": "Porucha", "sys.warning": "Varování",
  ...
  "crash.reset": "Reset", "crash.task": "úloha", "crash.fw": "fw", "crash.elf": "elf", "crash.corrupted": "poškozeno",
  "crash.download": "Stáhnout hlášení o pádu", "crash.copy": "Kopírovat diagnostiku", "crash.dismiss": "Smazat hlášení",
  ...
  "crash.ask_yes": "Smazat", "crash.ask_no": "Ponechat",
  ...
  "bug.copy": "Kopírovat a otevřít GitHub", "bug.download": "Stáhnout .md",
  ...
  "nav.settings": "Nastavení", "nav.back": "Zpět",
  ...
  "conn.homehub": "HomeHub", "conn.searching": "Hledám…",
  "group.Modbus": "Modbus",
  "conn.title": "Připojení", "conn.offline": "Offline", "conn.disabled": "Vypnuto",
  "conn.connecting": "Připojuji…", "conn.connected": "Připojeno", "conn.resolving": "Překládám adresu…",
  "conn.eth_no_cable": "Kabel není připojen", "conn.eth_no_lease": "Kabel je připojen, ale bez adresy",
  "conn.eth_fd": "plný duplex",
  "conn.enabled": "Zapnuto", "conn.enabled_noping": "Zapnuto, hostitel neodpovídá na ping",
  "conn.synced": "Synchronizováno", "conn.syncing": "Synchronizuji…",
  "conn.error": (e) => "Chyba: " + e, "conn.connected_to": (s) => "Připojeno k " + s,
  ...
  "modbus.exc.1": "nepovolená funkce", "modbus.exc.2": "nepovolená datová adresa",
  "modbus.exc.3": "nepovolená datová hodnota", "modbus.exc.4": "selhání zařízení",
  "modbus.exc.5": "požadavek potvrzen", "modbus.exc.6": "zařízení je zaneprázdněné",
  "modbus.exc.8": "chyba parity paměti", "modbus.exc.10": "cesta brány není dostupná",
  "modbus.exc.11": "cílové zařízení neodpovědělo", "modbus.exc.unknown": "neznámý důvod",
  "card.model": "Model", "card.hplink": "Spojení s tepelným čerpadlem", "card.online": "Online",
  "card.uptime": "Doba běhu",
  "card.freeheap": "Volná paměť", "card.maxalloc": "Největší volný blok",
  "card.offline": "Offline", "card.protocol": "Protokol", "card.rxpin": "Pin RX",
  "card.txpin": "Pin TX", "card.capacity": "Výkon",
  ...
  "card.rxpin_help": "GPIO, na kterém ESP32 přijímá data X10A z tepelného čerpadla. Když je spojení offline, výběr spustí nový pokus o automatickou detekci se zvolenou dvojicí.",
  ...
  "card.candidates": "Možné modely", "card.oueeprom": "ID venkovní jednotky",
  "card.checkup": "Diagnostika soustavy · 24 h",
  "check.fault": "Porucha jednotky", "check.dhw_loss": "Tepelná ztráta zásobníku TUV",
  "check.cycling": "Starty kompresoru",
  "check.defrost": "Cykly odmrazování", "check.pressure": "Nejnižší tlak vody",
  "check.flow": "Nejnižší průtok", "check.heater": "Záložní topné těleso",
  "check.retries": "Opakování ochrany",
  "check.status.ok": "V POŘÁDKU", "check.status.info": "POZNÁMKA",
  "check.status.warn": "VAROVÁNÍ", "check.status.collecting": "KONTROLA",
  "check.status.observation": "POUZE MĚŘENÍ", "check.status.experimental": "EXPERIMENTÁLNÍ",
  ...
  "check.fault_err": "Aktivní porucha", "check.fault_warn": "Aktivní varování",
  "check.fault_past": "Výskyt během posledních 24 h · nyní neaktivní", "check.fault_none": "Nic není aktivní",
  "check.fault_unknown": "Aktuální stav není znám",
  "check.fault_past_unknown": "Výskyt během posledních 24 h · aktuální stav není znám",
  "check.retry_seen": "Zjištěn nárůst čítače", "check.retry_none": "Nebyl zjištěn žádný nárůst",
  "values.waiting": "Čekám na první dotaz…",
  "values.sg_x10a_mode": "Režim Smart Grid (kontakty X10A)",
  "group.Operation": "Provoz", "group.Domestic hot water": "Teplá užitková voda",
  "group.Water circuit": "Vodní okruh", "group.Refrigerant / outdoor": "Chladivo / venkovní jednotka",
  "group.Electrical": "Elektrická část", "group.Device": "Zařízení", "group.Other values": "Ostatní hodnoty",
  "group.Protection": "Ochrana", "protect.limiting": "právě omezuje",
  "group.Values": "Hodnoty",
  "state.on": "ZAP", "state.off": "VYP",
  "enum.auto": "Automaticky", "enum.heating": "Vytápění", "enum.cooling": "Chlazení",
  "enum.no_error": "Bez chyby", "enum.fault": "Porucha", "enum.warning": "Varování",
  "enum.space_heating": "Vytápění prostoru", "enum.dhw": "TUV",
  "enum.free_running": "Volný provoz", "enum.forced_off": "Vynuceně vypnuto",
  "enum.recommended_on": "Doporučeno zapnout", "enum.forced_on": "Vynuceně zapnuto",
  "enum.unknown": (n) => `Neznámé (${n})`,
  "chip.space_on": "Prostorové V/CH ZAP", "chip.space_off": "Prostorové V/CH VYP", "chip.quiet": "Tichý režim",
  "schem.sg_boost": "BOOST",
  "sg.mode0": "Volný provoz", "sg.mode1": "Vynuceně vypnuto",
  "sg.mode2": "Doporučeno zapnout", "sg.mode3": "Vynuceně zapnuto",
  "schem.to_dhw": "3CV → TUV", "schem.to_space": "3CV → prostor",
  "normal.label": "Normální:",
  "meaning.label": "Jak hodnotu číst:",
  "hist.title": "Posledních 24 hodin", "hist.recorded": (h) => `Zaznamenáno · ${h} h`,
  "hist.now": "nyní", "hist.ago": (h) => `před ${h} h`,
  "hist.loading": "Načítám průběh…", "hist.none": "Dosud nebyly zaznamenány žádné hodnoty.",
  "hist.err": "Průběh není dostupný.",
  "hist.gaps": (n) => `${n} ${n === 1 ? "mezera" : n >= 2 && n <= 4 ? "mezery" : "mezer"} — neměřeno`,
  "hist.nm": "neměřeno", "hist.rel": (h) => `před ${h} h`,
  "hist.held": "venkovní jednotka stojí", "hist.heldnote": (h) => `${h} h v klidu — neměřeno`,
  "hist.forecast": "Open-Meteo · předpověď", "hist.in_hours": (h) => `za ${h} h`,
  ...
  "hist.state_active": "Aktivní", "hist.state_off": "Vypnuto",
  ...
  "hist.boost_total": (d) => `Boost aktivní · ${d}`,
  "hist.boost_none": "V zaznamenaném období nebyl režim Boost aktivní.",
  "hist.boost_ago_range": (a, b) => `před ${a}–${b} h`,
  "hist.boost_active": "Boost aktivní", "hist.boost_inactive": "Boost vypnutý",
  ...
  "hist.defrost_active": "Odmrazování aktivní", "hist.defrost_inactive": "Odmrazování vypnuté",
  ...
  "hist.quiet_active": "Tichý režim aktivní", "hist.quiet_inactive": "Tichý režim vypnutý",
  ...
  "hist.heater_active": "Topné těleso aktivní", "hist.heater_inactive": "Topné těleso vypnuté",
  ...
  "hist.preheat_active": "Předehřev zásobníku aktivní", "hist.preheat_inactive": "Předehřev zásobníku vypnutý",
  ...
  "hist.disinfection_active": "Dezinfekce aktivní", "hist.disinfection_inactive": "Dezinfekce vypnutá",
  ...
  "hist.buh_active": "Záložní topné těleso aktivní", "hist.buh_inactive": "Záložní topné těleso vypnuté",
  "hist.buh_step1": "Stupeň 1", "hist.buh_step2": "Stupeň 2",
  "hist.buh_aria": (l, d) => `${l} — časová osa záložního topného tělesa. ${d}. Jednotlivé vzorky lze přečíst klávesami se šipkami.`,
  "hist.valve_dhw_total": (d) => `TUV · ${d}`, "hist.valve_space_total": (d) => `Prostorový okruh · ${d}`,
  "hist.valve_none": "V zaznamenaném období nebyla zaznamenána poloha TUV.",
  "hist.valve_dhw": "TUV", "hist.valve_space": "Prostorový okruh",
  ...
  "hist.circ_on": "Běží", "hist.circ_off": "Zastaveno",
  ...
  "hist.valve2_on_total": (d) => `Výstup 2CV ZAP · ${d}`,
  "hist.valve2_off_total": (d) => `Výstup 2CV VYP · ${d}`,
  "hist.valve2_on": "Výstup 2CV ZAP", "hist.valve2_off": "Výstup 2CV VYP",
  ...
  "hist.flow_switch_on": "Stav X10A ZAP", "hist.flow_switch_off": "Stav X10A VYP",
  ...
  "toast.saved": "Uloženo", "toast.no_changes": "Žádné změny",
  "toast.reboot": "Restartuji — znovu se připojuji…", "toast.rebooted": "Restartováno — znovu se připojte k zařízení",
  "toast.busy_retry": "Zařízení je zaneprázdněné — zkuste to za chvíli", "toast.unreachable": "Zařízení se nepodařilo kontaktovat",
  "toast.rejected": "Odmítnuto", "toast.applying": "Poslední změna se stále provádí…",
  "toast.check_wifi": "Zkontrolujte nastavení WiFi", "toast.check_broker": "Zkontrolujte adresu brokeru",
  "toast.check_syslog_port": "Zkontrolujte port Syslogu",
  "toast.verifying_mqtt": "Ověřuji připojení MQTT…", "toast.saving_syslog": "Ukládám nastavení Syslogu…",
  "toast.saving_ntp": "Ukládám nastavení NTP…", "toast.trying_pins": "Zkouším piny…",
  "toast.saving_board": "Ukládám hardware desky…",
  "ota.uptodate": "aktuální", "ota.check_failed": "kontrola selhala", "ota.starting": "spouštím…",
  "ota.pct": (p) => `${p}%`, "ota.rebooting": "restartuji…", "ota.failed": "aktualizace selhala",
  "ota.timeout": "vypršel čas", "ota.cancelled": "zrušeno", "ota.busy": "zařízení je zaneprázdněné",
  "ota.unreachable": "zařízení není dostupné",
  "ota.active_title": "Aktualizace firmwaru", "ota.active_sub": (detail) => `Probíhá instalace · ${detail}`,
  "ota.active_sub_cached": (detail) => `Probíhá instalace · ${detail} · poslední přijatý stav`,
  "ota.snapshot_title": "Aktualizace firmwaru", "ota.snapshot_label": "Stav dat",
  ...
  "btn.saving": "Ukládám…", "btn.verifying": "Ověřuji…", "btn.save": "Uložit",
  "btn.cancel": "Zrušit", "btn.close": "Zavřít",
  "schem.outdoor_unit": "VENKOVNÍ JEDNOTKA", "schem.defrost_pill": "❄ odmrazování", "schem.outdoor": "Venku",
  "insp.close": "Zavřít",
  "schem.leaving_water": "Výstup PHE", "schem.dhw_tank": "ZÁSOBNÍK TUV", "schem.set": "žádaná",
  "schem.bsh_label": "El. těleso",
  "schem.space_circuit": "PROSTOROVÝ OKRUH", "schem.heating": "VYTÁPĚNÍ", "schem.cooling": "CHLAZENÍ",
  "schem.pump": "ČERPADLO", "schem.return": "Vstup PHE", "schem.room": "Místnost",
  "schem.flow_rate": "průtok", "schem.water_press": "tlak vody",
  "schem.r2t": "R2T", "schem.r3t": "R3T",
  "schem.flow_switch": "SPÍNAČ PRŮTOKU", "schem.valve2": "2CV",
  "wifi.title": "Konfigurace WiFi", "wifi.ssid": "Síť WiFi (SSID)", "wifi.pass": "Heslo WiFi",
  ...
  "mqtt.title": "Broker MQTT", "mqtt.hostport": "Hostitel : port", "mqtt.user": "Uživatelské jméno · volitelné",
  "mqtt.pass": "Heslo · volitelné", "mqtt.clear": "Odstranit uložené přihlašovací údaje — připojit anonymně",
  ...
  "dyn.state": "Stav",
  "dyn.state_recording": "Zaznamenávání", "dyn.state_recording_nowx": "Zaznamenávání · bez předpovědi",
  "dyn.state_waiting": "Čekám na vytápění prostoru", "dyn.state_cooling": "Chlazení · nevzorkuje se", "dyn.state_room": "Zdroj místnosti není použitelný",
  "dyn.state_x10a": "X10A je offline", "dyn.state_homehub": "HomeHub je offline",
  "dyn.state_gate": "Stav soustavy není znám", "dyn.state_mode": "Režim vytápění/chlazení není znám", "dyn.state_clock": "Hodiny nejsou nastaveny",
  "dyn.state_blocked": "Nezaznamenává se",
  "dyn.state_setup_room": "Nastavte zdroj místnosti", "dyn.state_setup_homehub": "HomeHub není nastaven",
  "dyn.state_homehub_disabled": "Diagnostika vypnuta — HomeHub je vypnutý",
  "dyn.state_no_broker": "Nezaznamenává se — chybí broker MQTT", "dyn.state_safe_mode": "Nezaznamenává se — nouzový režim",
  "dyn.state_inactive": "Nezaznamenává se — vzorkovač neběží",
  "dyn.room_off": "Pokojový termostat je vypnutý", "dyn.room_not_heating": "Pokojový termostat není v režimu vytápění",
  "dyn.room_stale": "Hodnota z místnosti je příliš stará", "dyn.room_no_value": "Čekám na hodnotu z místnosti",
  ...
  "dyn.room_no_time": "Čas měření chybí", "dyn.room_retained_no_time": "Uchovaná hodnota bez času měření",
  "dyn.room_future_time": "Čas měření je v budoucnosti", "dyn.room_backward_time": "Čas měření se posunul zpět",
  "dyn.room_invalid_time": "Neplatný čas měření",
  "dyn.room_no_enabled": "Chybí stav zapnuto/vypnuto termostatu", "dyn.room_no_hvac_mode": "Chybí provozní režim termostatu",
  "dyn.room_source": "Zdroj teploty místnosti",
  "dyn.weather": "Volitelná srovnávací předpověď", "dyn.strategy": "Diagnostický signál",
  ...
  "env.title": "Venkovní snímač", "env.card": "Venkovní klima", "env.none": "Žádný snímač",
  "env.temperature": "Teplota", "env.humidity": "Vlhkost", "env.pressure": "Tlak vzduchu",
  "env.sensor_state": "Snímač", "env.live": "Živě", "env.collecting": "Shromažďuji…",
  ...
  "env.unavailable": "Snímač není dostupný", "env.err_pins": "SDA a SCL musí být odlišné platné piny",
  "env.saving": "Ukládám konfiguraci venkovního snímače…", "env.checking": "Kontroluji ENV III…",
  ...
  "ref.name": "Název", "ref.temperature_source": "Zdroj teploty",
  "ref.target": "Cílová teplota", "ref.timestamp_source": "Zdroj časového údaje · volitelný",
  ...
  "ref.max_age_help": "Maximální povolené stáří zdrojové hodnoty od 10 do 3600 sekund.", "ref.error": "Poslední chyba",
  "ref.broker_off": "Broker MQTT je vypnutý", "ref.retained": "uloženo brokerem",
  "ref.time_untrusted": "Uchovaná hodnota bez důvěryhodného času měření", "ref.clock_unsynced": "Hodiny zařízení nejsou synchronizovány",
  "ref.now": "nyní", "ref.ago": (s) => `před ${s} s`, "ref.age_unknown": "neznámé",
  "ref.saved": "Zdroj teploty místnosti uložen",
  "ref.detail.status_label": "Stav:", "ref.detail.diagnosis_label": "Diagnostika topné křivky:",
  "ref.status.measurement_valid": "Měření je platné",
  "ref.status.not_configured": "Nenastaveno", "ref.status.usable": "Použitelné",
  "ref.status.unusable": "Nepoužitelné", "ref.status.error": "Chyba",
  "ref.status.stale": "Zastaralé", "ref.status.waiting": "Čekám",
  ...
  "ref.delete": "Smazat", "ref.deleting": "Mažu…",
  "ref.deleted": "Zdroj teploty místnosti a zachycená hodnota byly smazány",
  "circ.title": "Zdroj oběhového čerpadla", "circ.row": "Cirkulační čerpadlo TUV",
  "circ.default_name": "Cirkulační čerpadlo", "circ.name": "Název", "circ.topic": "Téma MQTT",
  "circ.power_path": "Cesta JSON k výkonu", "circ.time_path": "Cesta JSON k času",
  ...
  "circ.on_threshold": "ZAP od · W", "circ.off_threshold": "VYP do · W",
  "circ.max_age": "Maximální stáří · sekundy", "circ.confirm": "Potvrzení · sekundy",
  ...
  "circ.not_configured": "Nenastaveno", "circ.unavailable": "Nedostupné",
  "circ.broker_off": "Chybí broker MQTT",
  "circ.running": "Běží", "circ.stopped": "Zastaveno", "circ.checking": "Kontroluji",
  "circ.stale": "Zastaralé", "circ.waiting": "Čekám na zprávu",
  "circ.detail.source": "Zdroj", "circ.detail.power": "Činný výkon",
  "circ.detail.state": "Rozpoznaný stav", "circ.detail.age": "Stáří měření",
  "circ.delete": "Smazat", "circ.deleting": "Mažu…", "circ.deleted": "Zdroj oběhového čerpadla smazán",
  "circ.saved": "Zdroj oběhového čerpadla uložen", "circ.test_failed": "Nebyla přijata čitelná čerstvá hodnota výkonu čerpadla",
  ...
  "wx.title": "Předpověď počasí Open-Meteo", "wx.latitude": "Zeměpisná šířka", "wx.longitude": "Zeměpisná délka",
  "wx.waiting": "Čekám na předpověď", "wx.fetching": "Načítám předpověď Open-Meteo…",
  "wx.unavailable": "Nedostupné", "wx.error": "Chyba předpovědi Open-Meteo",
  "wx.detail.status": "Stav:", "wx.status.fresh": "Aktuální", "wx.status.inactive": "Vypnuto",
  "wx.status.fetching": "Aktualizuji", "wx.status.stale": "Zastaralé",
  "wx.status.unavailable": "Nedostupné", "wx.status.waiting": "Čekám",
  ...
  "syslog.title": "Server Syslog", "syslog.hostport": "Hostitel : port",
  ...
  "homehub.title": "Modbus", "homehub.host": "Hostitel · IP nebo název .local",
  "homehub.port": "Port", "homehub.unit": "ID jednotky",
  ...
  "hh.search": "Hledat", "hh.searching": "Hledám…",
  "hh.found": (host) => `HomeHub nalezen: ${host}`, "hh.not_found": "Nebyl nalezen žádný HomeHub — zadejte adresu ručně.",
  "hh.saved": "Nastavení Modbus uloženo",
  "hh.err_port": "Port musí být mezi 1 a 65535",
  "hh.err_unit": "ID jednotky musí být mezi 1 a 247",
  "board.title": "Hardware desky", "board.ledtype": "Stavová LED", "board.none": "Žádná",
  "board.reset_section": "Tlačítko reset", "board.env3_section": "ENV III · Venkovní snímač",
  "board.preset": "Deska", "board.preset_custom": "Vlastní", "board.not_selected": "Nevybráno",
  "board.led_gpio": "Jednobarevná LED (GPIO)", "board.led_ws2812": "Adresovatelná RGB (WS2812)",
  "board.ledpin": "Pin LED", "board.btnpin": "Pin tlačítka reset",
  ...
  "card.hardware": "Hardware", "card.hw_off": "Žádný",
  ...
  "card.hw_active_low": "aktivní v LOW", "card.hw_active_high": "aktivní v HIGH",
  ...
  "card.firmware": "Verze", "card.channel": "Kanál aktualizací",
  ...
  "chan.release": "Vydání", "chan.dev": "Vývoj",
  "chan.saved": (c) => `Kanál aktualizací: ${c}`,
  "card.proto_title": "Protokol", "card.fw_title": "Firmware",
  ...
  "diagnostics.off": "Vypnuto", "diagnostics.on": "Zapnuto",
  ...
  "lang.auto": "Prohlížeč", "lang.de": "Deutsch", "lang.en": "English", "lang.es": "Español",
