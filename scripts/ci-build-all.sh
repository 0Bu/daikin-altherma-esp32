...
suffix()     { case "$1" in esp32) echo "";; esp32s3) echo "-s3";; esp32c3) echo "-c3";; esp32c6) echo "-c6";; esp32c5) echo "-c5";; esac; }
chipfamily() { case "$1" in esp32) echo "ESP32";; esp32s3) echo "ESP32-S3";; esp32c3) echo "ESP32-C3";; esp32c6) echo "ESP32-C6";; esp32c5) echo "ESP32-C5";; esac; }
