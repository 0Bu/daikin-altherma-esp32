...
const I18N = {
  en: {
    ...
    "env.atoms3_header_hint": "AtomS3 Lite: use Grove GPIO2/1 or two offered header pins such as GPIO7/8. GPIO39 is unavailable for ENV III.",
  ...
  de: {
    ...
    "env.atoms3_header_hint": "AtomS3 Lite: Grove GPIO2/1 oder zwei angebotene Header-Pins wie GPIO7/8 verwenden. GPIO39 ist für ENV III nicht verfügbar.",
