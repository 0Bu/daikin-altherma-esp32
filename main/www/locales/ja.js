...
I18N.ja = localeValues([
  ...
  /* dyn.state_help_recording */ "暖房運転と有効な室温入力を確認できたため、生の室温誤差を記録中です。季節傾向を運転時間と制限データと共に読み、単発値で判定しません。",
  ...
  /* dyn.state_help_blocked */ "必要な入力がないため記録していません。入力が戻れば再開し、古いデータや曖昧なデータは採取しません。",
...
MODEL_DESCRIPTION_I18N.ja = modelDescriptionValues([
  ...
  ["静穏時のR5Tを測定。K/hは最大の時間降下率。ポンプ連動は相関で原因ではありません。0.8K/h以上で「情報」、上限1.85K/hはプロジェクト推計です。200L換算は補填電力目安で実測ではありません。"], // health_dhw_loss
  ...
  ["現在の空きRAMと24時間傾向。持続的な低下は未解放メモリを示唆します。再起動や停電後も完了した5分区間はフラッシュから復元されます。"], // free_heap
