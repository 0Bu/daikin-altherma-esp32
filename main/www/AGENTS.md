...
2. **Bilingual Copy Parity**: Every user-visible string, tooltip, label, and diagnosis must have complete English (EN) and German (DE) equivalents in the `i18n` dictionary. Run `scripts/run-ui-localization-audit.sh`.
