...
| 20 | **IDF-free host-tested logic core** (592 checks) | 🧪 | [`main/logic/`](../main/logic), [`test/test_logic.cpp`](../test/test_logic.cpp) |
...
CRC, config, discovery, the health gate — are **pure IDF-free logic verified on the host** (592 checks),
