#pragma once
// GENERATED profile from X10A value definitions: Altherma(LT_11-16kW_Hydrosplit_hydro_unit)
...
inline constexpr ValueDef altherma_lt_11_16kw_hydrosplit_hydro_unit[] = {
    ...
    {0x20, 14, 105, 2, 2, "Pressure sensor"},  // default_on
    {0x20, 14, 405, 2, 1, "Pressure sensor(T)"},  // default_on
